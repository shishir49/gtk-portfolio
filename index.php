...
<body>
    ...
    <div class="contents">
        ...
        <!-- <div class="content-segment pricing" id="pricing">
            ...
            <div class="content-body">
                <table class="custom-table two-third">
                    <thead>
                        <th>Features</th>
                        <th>Economy</th>
                        <th>Business</th>
                    ...
                    <tbody>
                        <tr>
                            <td>Unlimited Test</td>
                            <td>YES</td>
                            <td>YES</td>
                        </tr>
                        <tr>
                            <td>Downloading result (Excel, PDF, etc)</td>
                            <td>YES</td>
                            <td>YES</td>
                        </tr>
                        <tr>
                            <td>Access Student Result</td>
                            <td>YES</td>
                            <td>YES</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Hosting</td>
                            <td>Cpanel</td>
                            <td>Cpanel or Cloud</td>
                        </tr>
                        <tr>
                            <td>Yearly Chrage (BDT)</td>
                            <td>Depends on Storage Capacity</td>
                            <td>Depends on Hosting provider and Storage Capacity</td>
                        </tr>
                        <tr>
                            <td>Price (BDT)</td>
                            <td>20K</td>
